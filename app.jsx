...
function Work({ showNumbers, density }) {
  ...
  const categories = ["All", "Weddings", "Engagements", "Corporate", "Portraits", "Nightlife"];

  const items = [
    { cat: "Weddings", label: "vineyard ceremony\nsetúbal · may 2025", ratio: "3/4", span: 6 },
    { cat: "Weddings", label: "first dance, candlelit\nlisbon · jun 2025", ratio: "4/5", span: 6 },
    { cat: "Engagements", label: "praça do comércio\ngolden hour", ratio: "1/1", span: 4 },
    { cat: "Corporate", label: "product launch\ntech summit lx", ratio: "16/10", span: 8 },
    { cat: "Portraits", label: "studio portrait\nnatural window light", ratio: "3/4", span: 4 },
    { cat: "Nightlife", label: "club residency\n03:14 am", ratio: "4/5", span: 4 },
    { cat: "Weddings", label: "getting ready\nbride's suite", ratio: "4/5", span: 4 },
    { cat: "Weddings", label: "full reception\ntravelling shot", ratio: "16/9", span: 12 },
    { cat: "Engagements", label: "couple in alfama\nblue hour walk", ratio: "3/4", span: 4 },
    { cat: "Nightlife", label: "lux frágil\nresident dj set", ratio: "1/1", span: 4 },
    { cat: "Portraits", label: "birthday portrait\nintimate session", ratio: "3/4", span: 4 },
  ];
      ...
      <div style={{ maxWidth: 1480, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          {filtered.map((item, i) => (
            ...
            >
              <Photo label={item.label} ratio={item.ratio} tone={(i % 3) + 1} />
              <div style={{
                display: "flex",
                justifyContent: "space-between",
                marginTop: 10,
      ...
      <div style={{ maxWidth: 1480, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <div style={{ position: "sticky", top: 100 }}>
            <Photo label={"portrait of inn\nself-portrait · lisbon"} ratio="4/5" tone={1} />
          </div>
          ...
          <div style={{ fontSize: 19, lineHeight: 1.7, color: "var(--fg-dim)", fontWeight: 300 }}>
            ...
            <p style={{ margin: "0 0 20px" }}>
              Based in Lisbon, shooting weddings, engagements, corporate milestones
              and the occasional 3am club night. What connects them is the same
              thing — I'm looking for the <em>true</em> frame, not the pretty one.
...
function Services({ showNumbers }) {
  const services = [
    { n: "01", t: "Weddings", d: "Full-day coverage, from first-look to last dance. Documentary-led, lightly directed where it matters." },
    { n: "02", t: "Engagements", d: "60–90 min sessions around a place that means something. Alfama, Sintra, home." },
    { n: "03", t: "Corporate", d: "Conferences, launches, brand events. Fast delivery, usable edits next day." },
    { n: "04", t: "Birthdays & parties", d: "The people, the cake, the 2am hugs. Nothing staged." },
    { n: "05", t: "Concerts & nightlife", d: "Residencies, clubs, festivals. Comfortable in the dark." },
    { n: "06", t: "Portraits", d: "Personal, professional, or somewhere in between." },
  ];
  return (
...
function Journal({ showNumbers }) {
  const posts = [
    { label: "ana + tomás\nquinta", ratio: "1/1" },
    { label: "alfama at dusk\npersonal work", ratio: "1/1" },
    { label: "tech summit lx\nday two keynote", ratio: "1/1" },
    { label: "lux frágil\nresidency night", ratio: "1/1" },
    { label: "wedding details\nring + light", ratio: "1/1" },
    { label: "portrait study\nfilm, 35mm", ratio: "1/1" },
    { label: "sintra sunrise\n05:42 am", ratio: "1/1" },
    { label: "engagement walk\nbaixa, golden hour", ratio: "1/1" },
  ];
  return (
      ...
      <div style={{ maxWidth: 1480, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          {posts.map((p, i) => (
            ...
            >
              <Photo label={p.label} ratio={p.ratio} tone={(i % 3) + 1} />
              <div
                data-overlay
                style={{
                  position: "absolute",
          ...
          <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 28 }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginTop: 10 }}>
                {["Wedding", "Engagement", "Corporate", "Birthday", "Concert", "Portrait"].map((t) => (
                  <button
                    key={t}
                    type="button"
